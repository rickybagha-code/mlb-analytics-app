      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/probables" className="text-sm text-gray-400 hover:text-white transition-colors">
              Probable Pitchers
            </Link>
      ...
      <div className="space-y-2.5">
        {rows.map((row) => (
          <div key={row.label} className="flex items-center justify-between gap-2">
            ...
            <span className={`text-xs font-bold tabular-nums ${row.highlight ? 'text-blue-400' : 'text-white'}`}>
              {row.value}
            </span>
          </div>
        ))}
  ...
  return (
    <div className="col-span-full rounded-xl border border-gray-800 bg-gray-900 p-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-5">
        ...
        {split && (
          <span className="inline-flex items-center rounded-full bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-400 ring-1 ring-blue-500/20">
            {split}
          </span>
        )}
      </div>
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1.5 text-gray-400">
            Run a batter vs pitcher matchup powered by Cook The Books&apos; scoring engine.
          </p>
        </div>
        ...
        {!result && !loading && (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-800 bg-gray-900/30 py-20 text-center">
            ...
            <p className="text-sm text-gray-600 mt-1 max-w-xs">
              ...
              <span className="text-blue-400 font-medium">Run Matchup Analysis</span> to get started.
            </p>
            <Link
              href="/probables"
              className="mt-5 inline-flex items-center gap-1.5 text-sm text-blue-400 hover:text-blue-300 transition-colors"
            >
